...
class Application : FlutterApplication(), PluginRegistrantCallback {
    ...
    override fun registerWith(registry: PluginRegistry?) {
        ...
        if (!registry!!.hasPlugin("org.thebus.foreground_service")) {
            ForegroundServicePlugin.registerWith(registry!!.registrarFor("org.thebus.foreground_service"))
        }
    }
    ...
    // call, result ->
    // if (call.method == "runAlarmManager") {
    //     runAlarmManager()
    // }
    // }
    // }
